namespace BlueItem.Dialogs
{
    partial class FindItemForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ignoreLookCheck = new BlueItem.Controls.FlagCheckBox();
            this.readableCheck = new BlueItem.Controls.FlagCheckBox();
            this.hasElevationCheck = new BlueItem.Controls.FlagCheckBox();
            this.fullGroundCheck = new BlueItem.Controls.FlagCheckBox();
            this.forceUseCheckBox = new BlueItem.Controls.FlagCheckBox();
            this.hookEastCheck = new BlueItem.Controls.FlagCheckBox();
            this.rotatableCheck = new BlueItem.Controls.FlagCheckBox();
            this.useableCheck = new BlueItem.Controls.FlagCheckBox();
            this.hangableCheck = new BlueItem.Controls.FlagCheckBox();
            this.hookSouthCheck = new BlueItem.Controls.FlagCheckBox();
            this.flagCheckBox1 = new BlueItem.Controls.FlagCheckBox();
            this.moveableFlagCheckBox = new BlueItem.Controls.FlagCheckBox();
            this.stackableCheckBox = new BlueItem.Controls.FlagCheckBox();
            this.blockPathfinderCheckBox = new BlueItem.Controls.FlagCheckBox();
            this.blockMissilesCheckBox = new BlueItem.Controls.FlagCheckBox();
            this.unpassableCheckBox = new BlueItem.Controls.FlagCheckBox();
            this.resultGroupBox = new DarkUI.Controls.DarkGroupBox();
            this.serverItemList = new BlueItem.Controls.ServerItemListBox();
